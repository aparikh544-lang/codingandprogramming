      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          ...
          <div className="p-6">
            ...
            {business.reviewCount > 0 && business.url && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-6">
                <p className="text-sm text-blue-800">
                  ⭐ <strong>{business.reviewCount} reviews</strong> shown above are from Yelp. LocalConnect user reviews are shown below.
                </p>
              </div>
            )}
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4">LocalConnect User Reviews ({reviews.length})</h2>
          <div className="space-y-4 mb-8">
            {reviews.length === 0 ? (
              <p className="text-gray-500 text-center py-8">No LocalConnect user reviews yet. Be the first to review!</p>
            ) : (
